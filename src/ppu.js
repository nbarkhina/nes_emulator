define(["require", "exports", "./bithelper", "./cartridge"], function (require, exports, bithelper_1, cartridge_1) {
    "use strict";
    ...
    class PPU {
        constructor(nes) {
            ...
            this.renderScanline = 120;
            //used during rendering
            this.sprite_color = new Color(0, 0, 0);
            ...
            this.testUsePallete = false;
            this.testCurrentPalette = -1;
            this.nes = nes;
            this.initPalette();
        ...
        incrementTickAndScanline() {
            ...
            if (this.tick == 342) {
                this.tick = 0;
                this.scanline++;
                //this is to get it to approximately 89342 ticks
        ...
        readVRAM(address) {
            ...
            //nametable
                ...
                if (this.nes.cartridge.mirroring == cartridge_1.Mirroring.VERTICAL) {
                    if (address >= 0x2800)
                        address -= 0x800;
                }
                else if (this.nes.cartridge.mirroring == cartridge_1.Mirroring.HORIZONTAL) {
            ...
            //palette
                ...
                if (mirrored_address == 0x3F10)
                    mirrored_address = 0x3F00;
                if (mirrored_address == 0x3F14)
                    mirrored_address = 0x3F04;
                if (mirrored_address == 0x3F18)
                    mirrored_address = 0x3F08;
                if (mirrored_address == 0x3F1C)
                    mirrored_address = 0x3F0C;
        ...
        //REGISTER WRAPPERS
        parseControlRegister(value) {
            if (this.marioHack) { //mario hack
                if (this.scanline < 200)
                    this.nametable_x = bithelper_1.BitHelper.getBit(value, 0);
            }
            else
                this.nametable_x = bithelper_1.BitHelper.getBit(value, 0);
            this.nametable_y = bithelper_1.BitHelper.getBit(value, 1);
            this.increment_mode = bithelper_1.BitHelper.getBit(value, 2);
            this.pattern_sprite = bithelper_1.BitHelper.getBit(value, 3);
            this.pattern_background = bithelper_1.BitHelper.getBit(value, 4);
            this.sprite_size = bithelper_1.BitHelper.getBit(value, 5);
            this.slave_mode = bithelper_1.BitHelper.getBit(value, 6);
            this.enable_nmi = bithelper_1.BitHelper.getBit(value, 7);
            // console.log('Scanline) ' + this.scanline + ' Sprites) ' + this.pattern_sprite);
        }
        parseMaskRegister(value) {
            this.greyscale = bithelper_1.BitHelper.getBit(value, 0);
            this.show_background_leftmost = bithelper_1.BitHelper.getBit(value, 1);
            this.show_sprites_leftmost = bithelper_1.BitHelper.getBit(value, 2);
            this.show_background = bithelper_1.BitHelper.getBit(value, 3);
            this.show_sprites = bithelper_1.BitHelper.getBit(value, 4);
            this.emphasize_red = bithelper_1.BitHelper.getBit(value, 5);
            this.emphasize_green = bithelper_1.BitHelper.getBit(value, 6);
            this.emphasize_blue = bithelper_1.BitHelper.getBit(value, 7);
        }
        parseStatusRegister(value) {
            this.sprite_overflow = bithelper_1.BitHelper.getBit(value, 5);
            this.sprite_zero_hit = bithelper_1.BitHelper.getBit(value, 6);
            this.vertical_blank = bithelper_1.BitHelper.getBit(value, 7);
        }
        assembleControlRegister() {
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 0, this.nametable_x);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 1, this.nametable_y);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 2, this.increment_mode);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 3, this.pattern_sprite);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 4, this.pattern_background);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 5, this.sprite_size);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 6, this.slave_mode);
            this.nes.memory.ram[0x2000] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2000], 7, this.enable_nmi);
        }
        assembleMaskRegister() {
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 0, this.greyscale);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 1, this.show_background_leftmost);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 2, this.show_sprites_leftmost);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 3, this.show_background);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 4, this.show_sprites);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 5, this.emphasize_red);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 6, this.emphasize_green);
            this.nes.memory.ram[0x2001] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2001], 7, this.emphasize_blue);
        }
        assembleStatusRegister() {
            this.nes.memory.ram[0x2002] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2002], 5, this.sprite_overflow);
            this.nes.memory.ram[0x2002] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2002], 6, this.sprite_zero_hit);
            this.nes.memory.ram[0x2002] = bithelper_1.BitHelper.setBit(this.nes.memory.ram[0x2002], 7, this.vertical_blank);
        }
        paletteSwapTest() {
        ...
        renderTile(address, x_screen, y_screen, screen, scrolladjust_x, scrolladjust_y, nameTableIndex, nameTableGrid, spriteAttributes) {
            let realPalColor0 = null;
            let realPalColor1 = null;
            let realPalColor2 = null;
            let realPalColor3 = null;
            ...
            if (nameTableIndex != null) {
                ...
                let bit0 = bithelper_1.BitHelper.getBit(attribute_byte, 0);
                let bit1 = bithelper_1.BitHelper.getBit(attribute_byte, 1);
                ...
                let bit0 = bithelper_1.BitHelper.getBit(spriteAttributes, 0);
                let bit1 = bithelper_1.BitHelper.getBit(spriteAttributes, 1);
                ...
                realPalColor2 = this.nes.ppu.getPaletteColor(pallete_number + 2);
                realPalColor3 = this.nes.ppu.getPaletteColor(pallete_number + 3);
                let flip_h = bithelper_1.BitHelper.getBit(spriteAttributes, 6);
                if (flip_h)
                    flip_horizontal = true;
                let flip_v = bithelper_1.BitHelper.getBit(spriteAttributes, 7);
                if (flip_v)
                    flip_vertical = true;
            }
            let val1 = 0;
            ...
            for (let y = 0; y < 8; y++) {
                ...
                for (let x = 0; x < 8; x++) {
                    ...
                    if (realPalColor0 != null) {
                        if (color == 0)
                            palColor = realPalColor0;
                        else if (color == 1)
                            palColor = realPalColor1;
                        else if (color == 2)
                            palColor = realPalColor2;
                        else
                            palColor = realPalColor3;
                    ...
                    //using available palettes
                        ...
                        let palColor;
                        if (color == 0)
                            palColor = this.testCurrentColor0;
                        if (color == 1)
                            palColor = this.testCurrentColor1;
                        if (color == 2)
                            palColor = this.testCurrentColor2;
                        if (color == 3)
                            palColor = this.testCurrentColor3;
                        this.sprite_color.red = palColor.red;
                        this.sprite_color.green = palColor.green;
                        this.sprite_color.blue = palColor.blue;
                    }
                    ...
                    byte1 = byte1 << 1;
                    byte2 = byte2 << 1;
                    //uncomment to see gridlines
                    // if (y==0 || x==0){
                    //     this.sprite_color.red = 0;
                    //     this.sprite_color.green = 0;
                    //     this.sprite_color.blue = 0;  
                    // }
