...
export class Memory {
    ...
    inputCounter2 = 0; //controller 2 input
            ...
            //Controller
                ...
                //Controller 2
                    ...
                    if (this.inputCounter2 < 8) {
                        ...
                        this.inputCounter2++;
                        if (this.inputCounter2 == 1) return this.nes.inputController.Key_Action_A_2 ? 65 : 64; //A
                        if (this.inputCounter2 == 2) return this.nes.inputController.Key_Action_B_2 ? 65 : 64; //B
                        if (this.inputCounter2 == 3) return this.nes.inputController.Key_Action_Select_2 ? 65 : 64; //Select
                        if (this.inputCounter2 == 4) return this.nes.inputController.Key_Action_Start_2 ? 65 : 64; //Start
                        if (this.inputCounter2 == 5) return this.nes.inputController.Key_Up_2 ? 65 : 64; //Up
                        if (this.inputCounter2 == 6) return this.nes.inputController.Key_Down_2 ? 65 : 64; //Down
                        if (this.inputCounter2 == 7) return this.nes.inputController.Key_Left_2 ? 65 : 64; //Left
                        if (this.inputCounter2 == 8) return this.nes.inputController.Key_Right_2 ? 65 : 64; //Right
