define(["require", "exports", "./bithelper", "./cartridge"], function (require, exports, bithelper_1, cartridge_1) {
    ...
    class Memory {
        constructor(nes) {
            this.inputCounter = 0; //controller 1 input
            this.inputCounter2 = 0; //controller 2 input
            //for performance
                    ...
                    if (address == 0x4016) {
                        if (this.inputCounter < 9) {
                            ...
                            if (this.inputCounter == 1)
                                return this.nes.inputController.Key_Action_A ? 65 : 64; //A
                            if (this.inputCounter == 2)
                                return this.nes.inputController.Key_Action_B ? 65 : 64; //B
                            if (this.inputCounter == 3)
                                return this.nes.inputController.Key_Action_Select ? 65 : 64; //Select
                            if (this.inputCounter == 4)
                                return this.nes.inputController.Key_Action_Start ? 65 : 64; //Start
                            if (this.inputCounter == 5)
                                return this.nes.inputController.Key_Up ? 65 : 64; //Up
                            if (this.inputCounter == 6)
                                return this.nes.inputController.Key_Down ? 65 : 64; //Down
                            if (this.inputCounter == 7)
                                return this.nes.inputController.Key_Left ? 65 : 64; //Left
                            if (this.inputCounter == 8)
                                return this.nes.inputController.Key_Right ? 65 : 64; //Right
                            return 0;
                        }
                    }
                    //Controller 2
                    else if (address == 0x4017) {
                        if (this.inputCounter2 < 8) {
                            this.inputCounter2++;
                            if (this.inputCounter2 == 1)
                                return this.nes.inputController.Key_Action_A_2 ? 65 : 64; //A
                            if (this.inputCounter2 == 2)
                                return this.nes.inputController.Key_Action_B_2 ? 65 : 64; //B
                            if (this.inputCounter2 == 3)
                                return this.nes.inputController.Key_Action_Select_2 ? 65 : 64; //Select
                            if (this.inputCounter2 == 4)
                                return this.nes.inputController.Key_Action_Start_2 ? 65 : 64; //Start
                            if (this.inputCounter2 == 5)
                                return this.nes.inputController.Key_Up_2 ? 65 : 64; //Up
                            if (this.inputCounter2 == 6)
                                return this.nes.inputController.Key_Down_2 ? 65 : 64; //Down
                            if (this.inputCounter2 == 7)
                                return this.nes.inputController.Key_Left_2 ? 65 : 64; //Left
                            if (this.inputCounter2 == 8)
                                return this.nes.inputController.Key_Right_2 ? 65 : 64; //Right
                            return 0;
                        }
                    }
                    else
            ...
            if (address >= 0x4020 && address <= 0xFFFF) {
                if (address >= 0x8000) {
                    ...
                    if (this.mapper == 1) {
                        ...
                        if (bithelper_1.BitHelper.getBit(value, 7)) {
                         ...
                         {
                            this.mapperShiftRegister = this.mapperShiftRegister | (bithelper_1.BitHelper.getBit(value, 0) << this.mapperWriteCount);
        ...
        */
        applyMapper1(address, value) {
            if (address >= 0x8000 && address <= 0x9FFF) {
                //MAPPER CONTROL
                //set mirroring,prg mode,chr mode
                var mirroring = value & 0x3, prgMode = (value & 0xc) >> 2, chrMode = (value & 0x10) >> 4;
                if (mirroring == 2)
                    this.nes.cartridge.mirroring = cartridge_1.Mirroring.VERTICAL;
                if (mirroring == 3)
                    this.nes.cartridge.mirroring = cartridge_1.Mirroring.HORIZONTAL;
        ...
        applyMapper3(address, value) {
            ...
            if (address >= 0x8000 && address <= 0x9FFF) {
                if (odd) {
                    ...
                    this.mmc3PrgMode = bithelper_1.BitHelper.getBit(value, 6);
                    this.mmc3ChrA12 = bithelper_1.BitHelper.getBit(value, 7);
                    if (this.mmc3PrgMode == 0) {
                        // $8000-$9FFF swappable
                        // $C000-$DFFF fixed to second-last bank
                ...
                if (odd) {
                    ...
                    //set mirroring
                    let mirroring = bithelper_1.BitHelper.getBit(value, 0);
                    if (mirroring == 0)
                        this.nes.cartridge.mirroring = cartridge_1.Mirroring.VERTICAL;
                    else
                        this.nes.cartridge.mirroring = cartridge_1.Mirroring.HORIZONTAL;
